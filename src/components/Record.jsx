...
const Record = ({
  record: { id, productName, productPrice, productQuantity, cost },
  index,
  removeRecord,
}) => {
  return (
    <tr className="group odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
      ...
      <td className="px-6 py-4 text-end record-price">{productPrice} </td>
      <td className="px-6 py-4 text-end">
        ...
        <span className="record-q w-5 inline-block">{productQuantity}</span>
